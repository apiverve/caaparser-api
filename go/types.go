// Package caaparser provides a Go client for the CAA Record Parser API.
//
// For more information, visit: https://apiverve.com/marketplace/caaparser?utm_source=go&utm_medium=readme
package caaparser
...
// Request contains the parameters for the CAA Record Parser API.
//
// Parameters:
//   - record (required): string - The CAA record string to parse
type Request struct {
	Record string `json:"record"` // Required
}
...
// CaInfoData represents the ca_info object.
...
// InterpretationData represents the interpretation object.
type InterpretationData struct {
	Meaning string `json:"meaning"`
	Restriction string `json:"restriction"`
	Critical bool `json:"critical"`
	CriticalExplanation string `json:"critical_explanation"`
}
