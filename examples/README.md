# CAA Record Parser API - Examples

This folder contains example code for using the CAA Record Parser API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/caaparser',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/caaparser");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/caaparser](https://docs.apiverve.com/ref/caaparser)
