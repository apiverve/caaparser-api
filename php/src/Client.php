...
/**
 * Client for the CAA Record Parser API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/caaparser?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/caaparser';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\CaaparserClient] {$message}\n";
        }
    }
}
