...
namespace APIVerve.API.CAARecordParser
{
    ...
    /// <summary>
    /// Client for the CAARecordParser API
    /// </summary>
    public class CAARecordParserAPIClient
#if !NET20 && !NET35 && !NET40
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/caaparser";
        ...
        {
            { "record", new ValidationRule { Type = "string", Required = true } }
        };
        ...
        public CAARecordParserAPIClient(string apiKey)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CAARecordParserAPIClient(string apiKey, bool isSecure, bool isDebug)
#if !NET20 && !NET35 && !NET40
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public CAARecordParserAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, CAARecordParserQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(CAARecordParserQueryOptions options)
        {
        ...
        public ResponseObj Execute(CAARecordParserQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(CAARecordParserQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(CAARecordParserQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(CAARecordParserQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(CAARecordParserQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(CAARecordParserQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(CAARecordParserQueryOptions options)
        {
