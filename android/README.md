...
```gradle
dependencies {
    implementation 'com.github.apiverve:caaparser-api:1.1.14'
}
```
...
```java
import com.apiverve.caaparser.CAARecordParserAPIClient;
import com.apiverve.caaparser.APIResponse;
import com.apiverve.caaparser.APIException;

// Initialize the client
CAARecordParserAPIClient client = new CAARecordParserAPIClient("YOUR_API_KEY");

try {
    // Prepare request parameters
    Map<String, Object> parameters = new HashMap<>();
    parameters.put("record", "example.com. 3600 IN CAA 0 issue \"letsencrypt.org\"");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/caaparser](https://docs.apiverve.com/ref/caaparser)
...
- **Documentation:** [https://docs.apiverve.com/ref/caaparser](https://docs.apiverve.com/ref/caaparser)
- **Issues:** [GitHub Issues](https://github.com/apiverve/caaparser-api/issues)
